...
Render persisted assistant messages in both creation and editing chats as controlled CommonMark. Strip raw HTML and disable unsafe links, retain administrator messages as escaped plain text, and cover both formatting and injection behavior in the Livewire feature tests.
