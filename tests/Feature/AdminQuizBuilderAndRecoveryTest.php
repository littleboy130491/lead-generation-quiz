...
class AdminQuizBuilderAndRecoveryTest extends TestCase
{
    ...
    public function test_ai_quiz_interview_modal_is_available_when_provider_credentials_are_missing(): void
    {
        ...
        $this->assertStringContainsString('execute now', (string) $action->getModalDescription());
    }

    public function test_ai_quiz_interview_header_is_visible_on_create_when_provider_credentials_are_missing(): void
    {
        config(['ai.providers.openai.key' => null]);
        app(ApplicationSettings::class)->put('ai.quiz', [['provider' => 'openai', 'model' => 'gpt-test']]);
    ...
    public function test_ai_quiz_interview_modal_is_available_when_provider_credentials_are_configured(): void
    {
